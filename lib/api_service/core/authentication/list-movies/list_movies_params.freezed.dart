...
/// @nodoc
@JsonSerializable()
class _$_ListMoviesParams extends _ListMoviesParams {
  const _$_ListMoviesParams({this.language = 'en-US', this.page = 1})
      : super._();
...
abstract class _ListMoviesParams extends ListMoviesParams {
  const factory _ListMoviesParams({final String language, final int page}) =
      _$_ListMoviesParams;
  const _ListMoviesParams._() : super._();
